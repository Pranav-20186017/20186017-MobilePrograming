...
public class Calculator extends Application {
	...
	public final static double WINDOW_WIDTH = 1320;
	public final static double WINDOW_HEIGHT = 490;
	...
	public void start(Stage theStage) throws Exception {
		...
		theStage.setTitle("Chaitanya Puritipati");				 // Label the stage (a window)
