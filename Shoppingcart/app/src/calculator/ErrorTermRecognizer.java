...
public class ErrorTermRecognizer {
	...
	/**********
	 * This private method display the debugging info
	 * 
	 * @return Nothing
	 */
	...
	/**********
	 * This private method moves the current pointer to the next character
	 * 
	 * @return Nothing
	 */
	...
	public static String checkErrorTerm(String input) {
		...
		case 9:
			...
			errorTermErrorMessage = "This character may only be a non-zero digit.\n";
			return displayInput(input, currentCharNdx) + errorTermErrorMessage;
		
		case 6:
			//state 6 transition is only when input is a digit
		...
		case 8:
			//state 8 , input is accepted only when there is a decimal point.
